...
save_root = '../Output/'
#model = '../Models/doobnet_bsdsownership.caffemodel'
model = '../snapshots/doobnet_bsdsownership_iter_10000.caffemodel'

deploy_prototxt = 'deploy_doobnet_bsdsownership.prototxt'
